...
import (
	...
	"github.com/OlegDjur/go-grpc-order-svc/pkg/db"
	"github.com/OlegDjur/go-grpc-order-svc/pkg/models"
	"github.com/OlegDjur/go-grpc-order-svc/pkg/pb"
)
...
func (s *Server) CreateOrder(ctx context.Context, req *pb.CreateOrderRequest) (*pb.CreateOrderResponse, error) {
	...
	if err != nil {
		...
		return &pb.CreateOrderResponse{Status: http.StatusConflict, Error: "Strock too less"}, nil
	}
